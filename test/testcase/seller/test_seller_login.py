...
class Test(unittest.TestCase):
    ...
    def login(self,user,pwd):
        ...
        self.driver.get("https://merch.wkhgs.com") #卖家端登录域名
    ...
    def test_login_success(self):
        ...
        time.sleep(3)
        result = self.driver.find_elements_by_class_name("go-ui-link")
        if result != login_success:
            print("测试用例 B2C_seller-login-001"+"执行用例成功")
        else:
            self.driver.get_screenshot_as_file(
                "F:\TOOLS\python\PyCharmProjects\AutoTestDemo\screenshot\login_error.png")
            print("测试用例 B2C_seller-login-001"+"执行用例失败")
        self.driver.close()
    ...
    def test_login_user_error(self):
        ...
        if result != error_message:
            ...
            self.driver.get_screenshot_as_file(
            "F:\TOOLS\python\PyCharmProjects\AutoTestDemo\screenshot\login_user_error.png")
            print("测试用例 B2C_seller-login-002"+"执行测试失败")
        self.driver.close()
    ...
    def test_login_pwd_error(self):
        ...
        if result != error_message:
            ...
            self.driver.get_screenshot_as_file(
            "F:\TOOLS\python\PyCharmProjects\AutoTestDemo\screenshot\login_pwd_error.png")
    ...
    def test_login_user_null_error(self):
        ...
        if result != error_message:
            ...
            self.driver.get_screenshot_as_file(
            "F:\TOOLS\python\PyCharmProjects\AutoTestDemo\screenshot\login_user_null.png")
